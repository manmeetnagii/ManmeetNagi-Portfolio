...
export function BackgroundBeamsDemo() {
  return (
    <div id="contact" className="h-full mt-[3rem] w-full   border-t-2 border-[#1f1f1f] rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
       <div className="mt-[4rem] w-full z-[999] px-[8.2rem]">
            <h1 className="text-5xl w-full flex items-start justify-start font-semibold">CONTACT</h1>
            <p className="text-xl  mb-[3rem] font-medium text-gray-500">Send us a message</p>
